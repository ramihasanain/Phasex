...
export function LandingHero({ t, onGetStarted }: LandingHeroProps) {
  const accent = ACCENT;
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-3 mb-10">
            ...
            <div className="pt-3">
              ...
              <motion.p className="text-xl md:text-2xl font-bold mt-2" style={{ color: accent }} animate={{ scale: [1, 1.04, 1] }} transition={{ duration: 2, repeat: Infinity }}>
                {t("perceiveStructure")}
              </motion.p>
            </div>
          </div>
