...
interface LandingDecisionEngineSectionProps {
  t: LandingT;
  isRTL: boolean;
}

export function LandingDecisionEngineSection({ t, isRTL }: LandingDecisionEngineSectionProps) {
  const accent = ACCENT;
  ...
  return (
    <section id="decision-engine" className="py-20 relative z-10">
      <div className="container mx-auto px-4">
        <SectionTitle sub={t("decisionEngineSub")}>{t("structuralDecisionEngine")}</SectionTitle>
