            ...
            <table className="w-full" style={{ borderCollapse: "collapse" }}>
                <thead className="sticky top-0 z-10">
                    ...
                    >
                        ...
                        {mt5Connected && (
                            <>
                                <th
                                    className="p-3 text-[13px] font-black text-center tracking-wider uppercase"
                                    style={{
                                        color: "#fbbf24",
                ...
                <tbody>
                    {filteredAssets.length === 0 ? (
                        <tr>
                            <td colSpan={mt5Connected ? 11 : 8} className="p-8 text-center text-sm" style={{ color: "#334155" }}>{t("noResults")}</td>
                        </tr>
                    ) : (
