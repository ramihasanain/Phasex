...
const API_BASE = "https://phase-x-qc8dy.ondigitalocean.app/api/v1/displacement-state/read";
...
interface UseDisplacementStateAPIResult {
    candles: ChartCandle[];
    loading: boolean;
    error: string | null;
...
function getTimeframeStateKey(tf: number): string {
    switch (tf) {
        case 5: return "displacement_m5";
        case 10: return "displacement_m10";
        case 15: return "displacement_m15";
        case 30: return "displacement_m30";
        case 60: return "displacement_h1";
        case 120: return "displacement_h2";
        case 240: return "displacement_h4";
        case 360: return "displacement_h6";
        case 480: return "displacement_h8";
        case 720: return "displacement_h12";
        case 1440: return "displacement_d1";
        default: return `displacement_m${tf}`;
    }
}

export function useDisplacementStateAPI(
    symbol: string | undefined,
    timeframe: number,
    enabled: boolean
): UseDisplacementStateAPIResult {
    ...
    const fetchData = useCallback(async (sym: string, tf: number, isInitial: boolean) => {
        ...
        try {
            ...
            const m5StateKey = "displacement_m5";
            ...
            if (!json.candles || !Array.isArray(json.candles) || json.candles.length === 0) {
                throw new Error("No displacement data available");
            }
