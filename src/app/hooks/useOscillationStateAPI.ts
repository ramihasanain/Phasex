...
const API_BASE = "https://phase-x-qc8dy.ondigitalocean.app/api/v1/oscillation-state/read";
...
interface UseOscillationStateAPIResult {
    candles: ChartCandle[];
    loading: boolean;
    error: string | null;
...
function getTimeframeStateKey(tf: number): string {
    switch (tf) {
        case 5: return "oscillation_m5";
        case 10: return "oscillation_m10";
        case 15: return "oscillation_m15";
        case 30: return "oscillation_m30";
        case 60: return "oscillation_h1";
        case 120: return "oscillation_h2";
        case 240: return "oscillation_h4";
        case 360: return "oscillation_h6";
        case 480: return "oscillation_h8";
        case 720: return "oscillation_h12";
        case 1440: return "oscillation_d1";
        default: return `oscillation_m${tf}`;
    }
}

export function useOscillationStateAPI(
    symbol: string | undefined,
    timeframe: number,
    enabled: boolean
): UseOscillationStateAPIResult {
    ...
    const fetchData = useCallback(async (sym: string, tf: number, isInitial: boolean) => {
        ...
        try {
            ...
            const m5StateKey = "oscillation_m5";
            ...
            if (!json.candles || !Array.isArray(json.candles) || json.candles.length === 0) {
                throw new Error("No oscillation data available");
            }
